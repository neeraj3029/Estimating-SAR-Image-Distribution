...
```{r}
plot(exp_values_gamma, type='l', col='blue', lwd=2, ylab="Pixel Count", xlab="Pixel Values")
lines(exp_values_gaussian, type='l', col='orange', lwd=2)
lines(observed_counts, col = 'black', type='l',lwd=2)
legend(160, 2500, legend=c("Observed freq distribution", "Est. Gamma Dist.", "Sample distribution"),
